 ...
 */
public interface Response extends ReadStream<Buffer> {
    /**
     ...
     * @return
     */
    default Response customFrameHandler(Handler<HttpFrame> frameHandler) {
        return this;
    }
    ...
    default Response cancelHandler(Handler<Void> cancelHandler) {
        return this;
    }
