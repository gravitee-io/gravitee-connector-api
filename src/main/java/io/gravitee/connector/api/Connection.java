...
public interface Connection extends WriteStream<Buffer> {
     ...
     * @return
     */
    default Connection writeCustomFrame(HttpFrame frame) {
        return this;
    }
    ...
    default Connection cancelHandler(Handler<Void> cancelHandler) {
        return this;
    }

    default Connection exceptionHandler(Handler<Throwable> exceptionHandler) {
        return this;
    }

    default Connection responseHandler(Handler<Response> responseHandler) {
        return this;
    }
}
